...
import project4 from "./../assets/images/project (5).jpg";
import project5 from "./../assets/images/project (10).jpg";
        ...
        <main className="pt-20">
          ...
          <section className="py-20">
            <div className="max-w-8xl mx-auto px-6 lg:px-12">
              ...
              {/* Complex Grid Layout */}
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 auto-rows-[200px]">
                {project.images.map((image, index) => {
                  // Create varying grid spans for complex layout
                  const spans = ['col-span-2 row-span-2', 'col-span-1 row-span-1', 'col-span-1 row-span-2', 'col-span-2 row-span-1'];
                  const spanClass = spans[index % spans.length];
                  
                  return (
                    <div 
                      key={index}
                      className={`${spanClass} bg-muted rounded-lg overflow-hidden group cursor-pointer`}
                    >
                      <img 
                        src={image}
